                            ...
                            <form action="{{ route('admins.sanphams.update',$sanPham->id) }}" method="POST"
                                ...
                                <div class="row">
                                    <div class="col-lg-4">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control @error('mo_ta_ngan') is-invalid @enderror" name="mo_ta_ngan" id="mo_ta_ngan"
                                                cols="" rows="3" placeholder="Mô tả ngắn">{{ $sanPham->mo_ta_ngan }}</textarea>
                                            @error('mo_ta_ngan')
                                                <p class="text-danger">{{ $message }}</p>
                                            @enderror
                                        </div>
                                    ...
                                    @error('hinh_anh') is-invaild @enderror"
                                            ...
                                            <img id="img_danhmuc" src="{{Storage::url($sanPham->hinh_anh )}}" alt="ảnh sản phẩm" srcset=""
                                                style="width:150px;">
